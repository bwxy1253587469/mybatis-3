...
public class MapperMethod {
  ...
  public static class SqlCommand {
    ...
    public SqlCommand(Configuration configuration, Class<?> mapperInterface, Method method) {
      ...
      if (ms == null) {
        ...
        // 获得 name
        // 实际上，就是 ${NAMESPACE_NAME}.${语句_ID}， 例如："org.apache.ibatis.autoconstructor.AutoConstructorMapper.getSubject2" 。
        name = ms.getId();
        // 获得 type
     ...
     * @date 2019/4/24 9:12
     * @since
     * @param mapperInterface dao接口
     * @param methodName      dao方法名称
     * @param declaringClass  dao接口，也有可能是超类
  ...
  public static class MethodSignature {
    ...
    /**
     * 返回类型是否为游标 {@link org.apache.ibatis.cursor.Cursor}
     */
